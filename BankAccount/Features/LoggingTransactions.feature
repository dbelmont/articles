...
Background:
    ...
    And a customer makes a withdraw of $20.0 from his/hers account
...
Scenario: Requesting a transaction statement
    Given a customer makes a deposit of $40.0 into his/hers account with the reference "FFR5529"
